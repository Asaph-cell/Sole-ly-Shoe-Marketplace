...
import { DollarSign, ArrowDown, AlertCircle, TrendingUp } from 'lucide-react';
        ...
        <>
                    ...
                    {pendingBalance >= MINIMUM_AUTO_PAYOUT && (
                        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                            ...
                            <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                                Funds will be sent to your M-Pesa automatically. Platform pays the KES 100 fee.
                            </p>
                        </div>
                    )}
            ...
            <AlertDialog open={showManualPayoutDialog} onOpenChange={setShowManualPayoutDialog}>
                <AlertDialogContent>
                        ...
                        <AlertDialogDescription className="space-y-3">
                            ...
                            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
                                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                                    ⚠️ <strong>Consider waiting!</strong> If you wait until your balance reaches KES 1,500,
                                    the platform pays the processing fee and you keep more money.
                                </p>
                            </div>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel>Wait for Auto-Payout</AlertDialogCancel>
                        <AlertDialogAction
